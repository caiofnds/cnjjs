...
describe('method fromString', () => {
  describe('with number', () => {
    ...
    test('1-35.0001.1.01.0001', () => {
      const cnj = cnjjs.fromString('1-35.0001.1.01.0001').toObject();
      expect(cnj).toMatchObject(expected);
    });
    test('1-35.0001.1.01.1', () => {
      const cnj = cnjjs.fromString('1-35.0001.1.01.1').toObject();
      expect(cnj).toMatchObject(expected);
    });
    test('1-35.1.1.1.1', () => {
      const cnj = cnjjs.fromString('1-35.1.1.1.1').toObject();
      expect(cnj).toMatchObject(expected);
    });
  });
  describe('with year', () => {
    ...
    test('0000001-32.2001.1.01.0001', () => {
      const cnj = cnjjs.fromString('0000001-32.2001.1.01.0001').toObject();
      expect(cnj).toMatchObject(expected);
    });
    test('1-32.2001.1.01.0001', () => {
      const cnj = cnjjs.fromString('1-32.2001.1.01.0001').toObject();
      expect(cnj).toMatchObject(expected);
    });
    test('1-32.2001.1.01.1', () => {
      const cnj = cnjjs.fromString('1-32.2001.1.01.1').toObject();
      expect(cnj).toMatchObject(expected);
    });
    test('1-32.2001.1.1.1', () => {
      const cnj = cnjjs.fromString('1-32.2001.1.1.1').toObject();
      expect(cnj).toMatchObject(expected);
    });
    test('00000013220011010001', () => {
      const cnj = cnjjs.fromString('00000013220011010001').toObject();
      expect(cnj).toMatchObject(expected);
    });
    test('13220011010001', () => {
      const cnj = cnjjs.fromString('13220011010001').toObject();
      expect(cnj).toMatchObject(expected);
    });
  });
  describe('with valid number 00011268-83.2012.811.0055', () => {
    ...
    test('00011268-83.2012.811.0055', () => {
      const cnj = cnjjs.fromString('00011268-83.2012.811.0055').toObject();
      expect(cnj).toMatchObject(expected);
    });
  });
  describe('with valid number 506354-19.2011.08.09.0051', () => {
    ...
    test('506354-19.2011.08.09.0051', () => {
      const cnj = cnjjs.fromString('506354-19.2011.08.09.0051').toObject();
      expect(cnj).toMatchObject(expected);
    });
  });
  describe('with valid number 5000.822.53.2013.827.2706', () => {
    ...
    test('5000.822.53.2013.827.2706', () => {
      const cnj = cnjjs.fromString('5000.822.53.2013.827.2706').toObject();
      expect(cnj).toMatchObject(expected);
    });
  });
});
