...
describe('method withoutCheckDigit', () => {
  ...
  describe('generate validator', () => {
    it('0000001 2001 1 01 0001', () => {
      const cnj = cnjjs.withoutCheckDigit(1, 2001, 1, 1, 1);
      expect(cnj.dd).toEqual(32);
      expect(cnj.toString()).toBe('');
      expect(cnj.isValid()).toBeFalsy();
    });
    it('1 1 1 1 1', () => {
      const cnj = cnjjs.withoutCheckDigit(1, 1, 1, 1, 1);
      expect(cnj.dd).toEqual(35);
      expect(cnj.toString()).toBe('');
      expect(cnj.isValid()).toBeFalsy();
    });
    it('123456789012345678', () => {
      const cnj = cnjjs.withoutCheckDigit(1234567, 8901, 2, 34, 5678);
      expect(cnj.dd).toEqual(88);
      expect(cnj.toString()).toBe('');
      expect(cnj.isValid()).toBeFalsy();
    });
    it('987654321098765432', () => {
      const cnj = cnjjs.withoutCheckDigit(9876543, 2109, 8, 76, 5432);
      expect(cnj.dd).toEqual(46);
      expect(cnj.toString()).toBe('');
      expect(cnj.isValid()).toBeFalsy();
    });
